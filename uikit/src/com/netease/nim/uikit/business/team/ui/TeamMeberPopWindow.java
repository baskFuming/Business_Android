...
public class TeamMeberPopWindow extends PopupWindow {
    private View window;
    ...
    public TeamMeberPopWindow(final Activity context, View.OnClickListener listener) {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        window = inflater.inflate(R.layout.team_dialog, null);
        setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE);
        close = (ImageView) window.findViewById(R.id.close);
        content = (EditText) window.findViewById(R.id.info_et);
        send = (Button) window.findViewById(R.id.sends);
