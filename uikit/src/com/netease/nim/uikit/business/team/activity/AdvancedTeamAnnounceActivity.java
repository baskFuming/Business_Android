...
public class AdvancedTeamAnnounceActivity extends UI implements TAdapterDelegate {
    ...
    private void parseIntentData() {
        ...
        teamNotify = (EditText) findViewById(R.id.team_notify);
    ...
    private void initActionbar() {
        ...
        toolbarView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NIMClient.getService(TeamService.class).updateTeam(teamId, TeamFieldEnum.Announcement, teamNotify.getText().toString()).setCallback(new RequestCallback<Void>() {
                    @Override
                    public void onSuccess(Void param) {
                        // 成功
                        Toast.makeText(AdvancedTeamAnnounceActivity.this, "保存成功！", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                    ...
                    public void onFailed(int code) {
                        // 失败
                        Toast.makeText(AdvancedTeamAnnounceActivity.this, String.format(getString(R.string.no_permission), code), Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onException(Throwable exception) {
                        // 错误
                        Toast.makeText(AdvancedTeamAnnounceActivity.this, getString(R.string.update_failed), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void requestTeamData() {
        ...
        if (t != null) {
            ...
            if (t.getAnnouncement().toString().equals("")) {
                teamNotify.setText("暂无群公告");
            } else {
                teamNotify.setText(t.getAnnouncement().toString());
            }
        } else {
    ...
    private void requestAnnounceData() {
        ...
        if (TextUtils.isEmpty(teamNotify.getText().toString())) {
            Toast.makeText(AdvancedTeamAnnounceActivity.this, R.string.team_announce_notice, Toast.LENGTH_SHORT).show();
            return;
        }
...
//                        toolbarView.setEnabled(true);
    ...
    private void updateAnnounce() {
        String announcement = AnnouncementHelper.makeAnnounceJson(announce, "",
                teamNotify.getText().toString());
        NIMClient.getService(TeamService.class).updateTeam(teamId, TeamFieldEnum.Announcement, announcement).setCallback(new RequestCallback<Void>() {
            ...
            public void onSuccess(Void param) {
                ...
                showKeyboard(false);
                finish();
                Toast.makeText(AdvancedTeamAnnounceActivity.this, R.string.update_success, Toast.LENGTH_SHORT).show();
            }
            ...
            public void onFailed(int code) {
                DialogMaker.dismissProgressDialog();
//                toolbarView.setEnabled(true);
                Toast.makeText(AdvancedTeamAnnounceActivity.this, String.format(getString(R.string.update_failed), code), Toast.LENGTH_SHORT).show();
            }
...
//            Toast.makeText(AdvancedTeamAnnounceActivity.this, "1", Toast.LENGTH_SHORT).show();
//        } else {
//            toolbarView.setVisibility(View.GONE);
//            Toast.makeText(AdvancedTeamAnnounceActivity.this, "2", Toast.LENGTH_SHORT).show();
//        }
    }
