...
public class TeamMessageActivity extends BaseMessageActivity {
    ...
    protected void findViews() {
        ...
        groupName = (TextView)findView(R.id.group_name);
        groupInfo = (ImageView) findView(R.id.group_info);
    ...
    private void requestTeamInfo() {
        ...
        groupInfo.setImageResource(R.drawable.nim_ic_message_actionbar_team);
        groupInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (team != null && team.isMyTeam()) {
                    ...
                    Toast.makeText(getApplicationContext(), R.string.team_invalid_tip, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
