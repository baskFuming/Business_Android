...
public class ImageViewPluls extends ImageView {
    /**
    ...
    public ImageViewPluls(Context context, AttributeSet attrs) {
        super(context, attrs);
        //取xml文件中设定的参数
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ImageViewPlu);
        mType = ta.getInt(R.styleable.ImageViewPlu_type, DEFAULT_TYPE);
        mBorderColor = ta.getColor(R.styleable.ImageViewPlu_borderColor, DEFAULT_BORDER_COLOR);
        mBorderWidth = ta.getDimensionPixelSize(R.styleable.ImageViewPlu_borderWidth, dip2px(DEFAULT_BORDER_WIDTH));
