 ...
 * 关注动态头列表
 */
public class RecommendDynamicHeadAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<AtentionDynamicHeadBean.DataBean.ListBean> list;
    private Context context;

    public RecommendDynamicHeadAdapter(List<AtentionDynamicHeadBean.DataBean.ListBean> list, Context context) {
        this.list = list;
