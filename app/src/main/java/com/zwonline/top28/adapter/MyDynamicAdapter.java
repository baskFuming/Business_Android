...
public class MyDynamicAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyDynamicAdapter(List<NewContentBean.DataBean> list, Context context) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.newcontent_item, parent, false);
            ...
            if (list.get(pos).comments_excerpt.size() > 0) {
                ...
                if (list.get(pos).comments_excerpt.size() == 1) {
                    ...
                    if (list.get(pos).user_id.equals(uid)) {
                        ...
                        spannable2.setSpan(new TextClick(context, list.get(pos).comments_excerpt.get(0).user_id), 0, list.get(pos).comments_excerpt.get(1).nickname.length(), Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
