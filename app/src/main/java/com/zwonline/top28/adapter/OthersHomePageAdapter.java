...
public class OthersHomePageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public OthersHomePageAdapter(List<NewContentBean.DataBean> list, Context context) {
        this.list = list;
...
//                    myViewHolder.comment_user1.setText(list.get(position).comments_excerpt.get(0).nickname + ":" + list.get(position).comments_excerpt.get(0).content);
                    ...
                    spannable.append(":");
                    spannable.append(stringFilter(list.get(position).comments_excerpt.get(0).content));
                    ...
                    spannable1.append(":");
                    spannable1.append(stringFilter(list.get(position).comments_excerpt.get(0).content));
                    spannable2.append(":");
                    spannable2.append(stringFilter(list.get(position).comments_excerpt.get(1).content));
                    if (list.get(position).user_id.equals(uid)) {
...
//        });
        myViewHolder.attention_linear.setVisibility(View.GONE);
        myViewHolder.more_setting.setVisibility(View.GONE);
        //更多功能
