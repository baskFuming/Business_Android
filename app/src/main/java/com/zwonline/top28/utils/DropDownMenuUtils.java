 ...
 *  多条件筛选菜单
 */
public class DropDownMenuUtils extends LinearLayout{
    //顶部菜单布局
    ...
    public DropDownMenuUtils(Context context) {
        super(context, null);
    }

    public DropDownMenuUtils(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DropDownMenuUtils(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setDropDownMenu(@NonNull List<String> tabTexts, @NonNull List<View> popupViews, @NonNull View contentView) {
        ...
        popupMenuViews.setLayoutParams(new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (int) (com.zwonline.top28.utils.DeviceUtils.getScreenSize(getContext()).y*menuHeighPercent)));
