...
public class MySharePopwindow extends PopupWindow {
    ...
    private View window;
    public MySharePopwindow(final Activity context) {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        window = inflater.inflate(R.layout.myshare_pop_item, null);
        setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE);

        imageView = (ImageView) window.findViewById(R.id.share_image);
