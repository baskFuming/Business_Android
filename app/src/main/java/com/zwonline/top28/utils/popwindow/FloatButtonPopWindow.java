 ...
 * 创业圈弹框
 */
public class FloatButtonPopWindow extends PopupWindow{
    private View mView;
    public FloatButtonPopWindow(final Activity context, View.OnClickListener itemsOnClick) {
        super(context);
        LayoutInflater mInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mView = mInflater.inflate(R.layout.flotbuttonpop, null);
        ...
        ImageView canaleTv = (ImageView) mView.findViewById(R.id.share_cancle);
