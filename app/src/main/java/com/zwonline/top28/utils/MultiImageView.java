...
public class MultiImageView extends LinearLayout {
    ...
    // 照片的Url列表
    private List<PhotoInfos> imagesList;
    ...
    public void setList(List<PhotoInfos> lists) throws IllegalArgumentException {
        if (lists == null) {
    ...
    private ImageView createImageView(int position, final boolean isMultiImage) {
        PhotoInfos photoInfo = imagesList.get(position);
    ...
    private class ImageOnClickListener implements OnClickListener {
        ...
        public ImageOnClickListener(int positions) {
