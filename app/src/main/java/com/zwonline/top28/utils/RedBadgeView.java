...
public class RedBadgeView extends TextView {
     ...
     */
    public RedBadgeView(Context context, View target) {
     ...
     */
    public RedBadgeView(Context context, TabWidget target, int index) {
        this(context, null, android.R.attr.textViewStyle, target, index);
    }

    public RedBadgeView(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs, defStyle, null, 0);
    }

    public RedBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
