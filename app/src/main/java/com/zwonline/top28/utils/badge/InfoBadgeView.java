...
public class InfoBadgeView extends TextView {
    private boolean mHideOnNull = true;

    public InfoBadgeView(Context context) {
        this(context, null);
    }

    public InfoBadgeView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public InfoBadgeView(Context context, AttributeSet attrs, int defStyle) {
