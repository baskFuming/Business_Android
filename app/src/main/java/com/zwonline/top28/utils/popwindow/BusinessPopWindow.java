 ...
 *  红包推荐弹框  调起商机币红包
 */
public class BusinessPopWindow extends PopupWindow{
    private View mView;
    public BusinessPopWindow(final Activity context, View.OnClickListener itemsOnClick) {
        super(context);
        LayoutInflater mInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mView = mInflater.inflate(R.layout.recommend_pop, null);
