...
public class BadgeView extends TextView {
    ...
    public void setBadgeCount(int count) {
        double youIn = Double.parseDouble(String.valueOf(count));
        double l = 10000;
        DecimalFormat df = new DecimalFormat("0.00");
        if (count < 10000) {
            setText(String.valueOf(count));
        } else if (count % 10000 == 0 && count < 100000) {
            setText(String.valueOf(count).substring(0, 1) + "万");
        } else if (count % 10000 == 0 && count >= 100000) {
            setText(String.valueOf(count).substring(0, 2) + "万");
        } else if (count > 10000) {
            setText(df.format(youIn / l) + "万");
        }
    }
