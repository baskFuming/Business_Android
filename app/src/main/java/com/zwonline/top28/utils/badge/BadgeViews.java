package com.zwonline.top28.utils.badge;
...
public class BadgeViews extends TextView {

    private boolean mHideOnNull = true;

    public BadgeViews(Context context) {
        this(context, null);
    }

    public BadgeViews(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public BadgeViews(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setLayoutParams(int wrapContent, int wrapContent1, int right, int centerVertical) {
    }
}
