...
public class MainBadgeView extends TextView {

    private boolean mHideOnNull = true;

    public MainBadgeView(Context context) {
        this(context, null);
    }

    public MainBadgeView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public MainBadgeView(Context context, AttributeSet attrs, int defStyle) {
