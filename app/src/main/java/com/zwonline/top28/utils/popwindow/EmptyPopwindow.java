...
public class EmptyPopwindow extends PopupWindow {
    private View mView;

    public EmptyPopwindow(Activity context, View.OnClickListener itemsOnClick) {
        super(context);
    ...
    private void initView(final Activity context, View.OnClickListener itemsOnClick) {
        ...
        chat.setText("全部消息已读");
        Button call = (Button) mView.findViewById(R.id.cancel_attention);
        call.setText("清空聊天列表");
