...
import com.zwonline.top28.adapter.OthersHomePageAdapter;
 ...
 * 他人主页动态
 */
public class OthersHomePageFrag extends BasesFragment<ISendFriendCircleActivity, SendFriendCirclePresenter> implements ISendFriendCircleActivity {
...
//        StatusBarUtil.setColor(getActivity(), getResources().getColor(R.color.black), 0);
    ...
    private void recyclerViewData() {
        ...
        adapter = new OthersHomePageAdapter(newContentList, getActivity());
    ...
    public void showConment(final List<NewContentBean.DataBean> newList) {
        ...
        loadMore();//上拉刷新下拉加载
        adapter.setOnClickItemListener(new OthersHomePageAdapter.OnClickItemListener() {
        ...
        //分享动态
        adapter.shareSetOnclick(new OthersHomePageAdapter.ShareInterface() {
            @Override
        ...
        //更多功能
        adapter.funtcionSetOnclick(new OthersHomePageAdapter.FunctionInterface() {
            @Override
        ...
        //刪除动态
        adapter.deleteSetOnclick(new OthersHomePageAdapter.DeleteInterface() {
            @Override
            public void onclick(View view, int position) {
                positions = position;
        ...
        //文章详情
        adapter.articleSetOnclick(new OthersHomePageAdapter.ArticleInterface() {
            @Override
            public void onclick(View view, int position) {
        ...
        //关注
        adapter.attentionSetOnclick(new OthersHomePageAdapter.AttentionInterface() {
            @Override
            public void onclick(View view, int position, TextView attention) {
        ...
        //点赞
        adapter.likeMomentSetOnclick(new OthersHomePageAdapter.LikeMomentInterface() {
...
//                        ToastUtils.showToast(getActivity(), newContentList.get(i) + "");
    ...
    public void onStart() {
        super.onStart();
//        if (getActivity() != null) {
//            presenter.MomentList(getActivity(), 0, userId, "");
//        }
    }
