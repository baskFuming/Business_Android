package com.zwonline.top28.nim.chatroom.fragment;
...
import com.zwonline.top28.nim.chatroom.activity.ChatRoomActivity;
import com.zwonline.top28.nim.chatroom.adapter.ChatRoomTabPagerAdapter;
import com.zwonline.top28.nim.chatroom.fragment.tab.ChatRoomTabFragment;
import com.zwonline.top28.nim.chatroom.helper.ChatRoomHelper;
import com.zwonline.top28.nim.common.ui.viewpager.FadeInOutPageTransformer;
import com.zwonline.top28.nim.common.ui.viewpager.PagerSlidingTabStrip;
...
public class ChatRoomFragment extends ChatRoomTabFragment implements ViewPager.OnPageChangeListener {
    ...
    private void setupTabs() {
        ...
        tabs.setOnTabClickListener((PagerSlidingTabStrip.OnTabClickListener) adapter);
        tabs.setOnTabDoubleTapListener((PagerSlidingTabStrip.OnTabDoubleTapListener) adapter);
    }
