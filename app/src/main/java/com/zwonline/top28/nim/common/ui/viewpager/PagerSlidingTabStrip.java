...
package com.zwonline.top28.nim.common.ui.viewpager;
...
import com.zwonline.top28.nim.main.reminder.ReminderSettings;
...
public class PagerSlidingTabStrip extends HorizontalScrollView implements OnPageChangeListener {
    ...
    private int underlineColor = Color.parseColor("#FF2B2B");// 0xFFD9D9D9;

    private int dividerColor = 0x00000000;

    private int checkedTextColor = R.color.color_blue_0888ff;

    private int unCheckedTextColor = R.color.umeng_socialize_shareactivity;
...
//        a = context.obtainStyledAttributes(attrs, R.styleable.PagerSlidingTabStrip);
        ...
        unCheckedTextColor = a.getResourceId(R.styleable.TwoTextView_ttLeftTextColor,
                R.color.umeng_socialize_shareactivity);
        indicatorHeight = a
