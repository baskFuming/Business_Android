package com.zwonline.top28.nim.chatroom.adapter;
...
import com.zwonline.top28.nim.chatroom.fragment.tab.ChatRoomTab;
    ...
    public ChatRoomTabPagerAdapter(FragmentManager fm, Context context, ViewPager pager) {
        ...
        for (ChatRoomTab tab : ChatRoomTab.values()) {
            try {
                ...
                @SuppressLint("RestrictedApi") List<Fragment> fs = fm.getFragments();
                if (fs != null) {
                    for (Fragment f : fs) {
