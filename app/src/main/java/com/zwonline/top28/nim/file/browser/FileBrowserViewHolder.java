package com.zwonline.top28.nim.file.browser;
...
public class FileBrowserViewHolder extends TViewHolder {
    ...
    protected void inflate() {
        directoryBitmap = BitmapFactory.decodeResource(DemoCache.getContext().getResources(), R.mipmap.bankcard);
        fileBitmap = BitmapFactory.decodeResource(DemoCache.getContext().getResources(), R.mipmap.bankcard);
