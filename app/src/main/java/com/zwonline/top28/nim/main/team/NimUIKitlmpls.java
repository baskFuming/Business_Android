...
import com.zwonline.top28.nim.main.activity.GroupDataActivity;

public class NimUIKitlmpls {
    ...
    // 单聊界面定制
    public static SessionCustomization commonP2PSessionCustomization;
    ...
    public static void init(Context context, UIKitOptions options, IUserInfoProvider userInfoProvider, ContactProvider contactProvider) {
        NimUIKitlmpls.context = context.getApplicationContext();
        NimUIKitlmpls.options = options;
        // init tools
        ...
        NimUIKitlmpls.imageLoaderKit = new ImageLoaderKit(context);
    ...
    private static void initUserInfoProvider(IUserInfoProvider userInfoProvider) {
        ...
        NimUIKitlmpls.userInfoProvider = userInfoProvider;
    }
    ...
    private static void initContactProvider(ContactProvider contactProvider) {
        ...
        NimUIKitlmpls.contactProvider = contactProvider;
    }
    ...
    public static void startP2PSession(Context context, String account, IMMessage anchor) {
        NimUIKitlmpls.startChatting(context, account, SessionTypeEnum.P2P, commonP2PSessionCustomization, anchor);
    }
    ...
    public static void startTeamSession(Context context, String tid, IMMessage anchor) {
        NimUIKitlmpls.startChatting(context, tid, SessionTypeEnum.Team, commonTeamSessionCustomization, anchor);
    }
    ...
    public static void startChatting(Context context, String id, SessionTypeEnum sessionType, SessionCustomization
        ...
        if (sessionType == SessionTypeEnum.P2P) {
            ...
            TeamMessagesActivity.start(context, id, customization, null, anchor);
        }
    }
    ...
    public static void startTeamInfo(Context context, String teamId) {
        ...
        if (team.getType() == TeamTypeEnum.Advanced) {
            GroupDataActivity.start(context, teamId); // 启动固定群资料页
    ...
    public static void setSessionListener(SessionEventListener sessionListener) {
        NimUIKitlmpls.sessionListener = sessionListener;
    }
    ...
    public static void setContactEventListener(ContactEventListener contactEventListener) {
        NimUIKitlmpls.contactEventListener = contactEventListener;
    }

    public static void setMsgForwardFilter(MsgForwardFilter msgForwardFilter) {
        NimUIKitlmpls.msgForwardFilter = msgForwardFilter;
    }
    ...
    public static void setMsgRevokeFilter(MsgRevokeFilter msgRevokeFilter) {
        NimUIKitlmpls.msgRevokeFilter = msgRevokeFilter;
    }
    ...
    public static void setCustomPushContentProvider(CustomPushContentProvider mixPushCustomConfig) {
        NimUIKitlmpls.customPushContentProvider = mixPushCustomConfig;
    }
    ...
    public static void setOnlineStateContentProvider(OnlineStateContentProvider onlineStateContentProvider) {
        NimUIKitlmpls.onlineStateContentProvider = onlineStateContentProvider;
    }
