...
public class ChatRoomHelper {
    private static final int[] imageRes = {R.mipmap.hetong_explain3, R.mipmap.hetong_explain3, R.mipmap.hetong_explain3,
            R.mipmap.hetong_explain3, R.mipmap.hetong_explain3, R.mipmap.hetong_explain3, R.mipmap.hetong_explain3,
            R.mipmap.hetong_explain3};
